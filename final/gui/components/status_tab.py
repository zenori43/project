...
def create_status_tab():
    """
    สร้าง Status Tab (Modbus Status)
    Returns:
    ...
    angle3_retry_status = QLabel("โหมดถ่ายภาพซ้ำ: ปิด")
    angle3_retry_status.setStyleSheet("color: #7f8c8d; padding: 5px; font-size: 12px;")
    system_layout.addWidget(angle3_retry_status)
    ...
    widgets_dict = {
        ...
        'angle3_retry_status': angle3_retry_status,
