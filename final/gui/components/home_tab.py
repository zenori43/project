...
def create_home_tab():
    ...
    bottle_image_label.setMinimumSize(400, 300)
    ...
    bottle_crops_scroll.setMinimumSize(250, 300)
    ...
    bottle_results_text.setMinimumSize(300, 300)
    ...
    cap_image_label.setMinimumSize(400, 300)
    ...
    cap_results_scroll.setMinimumSize(300, 300)
    ...
    cap_detection_text.setMinimumSize(300, 300)
