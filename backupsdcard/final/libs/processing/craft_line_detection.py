...
class CRAFTLineDetector:
    ...
    def save_detection_result(self, output_path: str, result: Dict = None) -> bool:
        ...
        try:
            ...
            # Convert numpy objects to JSON-serializable structures.
            # (e.g. numpy.ndarray -> list, numpy scalar -> Python scalar)
            ...
            with open(metadata_path, 'w', encoding='utf-8') as f:
                def _json_default(o):
                    # Last-resort handler for anything json doesn't know how to encode
