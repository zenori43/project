...
class RotationModel:
    ...
    def process_craft_rotated_image_with_retry(self, craft_rotated_image: np.ndarray, line_detector, ocr_model, rotation_callback=None, use_cache: bool = True) -> Dict:
        """
        Process CRAFT rotated image with parallel rotation retry (180°, -180°) for OCR.
        ...
        print("🚀 ROTATION RETRY: Starting parallel processing (2 rotations: 0°, 180°)...")
        result = self._process_with_parallel(craft_rotated_image, line_detector, ocr_model, rotation_callback)
        
        # เก็บผลลัพธ์ไว้ใน cache (ถ้าเปิดใช้งาน)
