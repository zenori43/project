...
class RobotTestHandlers:
    ...
    def read_register(self):
        ...
        try:
            ...
            # อ่านค่า
            result = self.gui.modbus_thread.modbus_client.read_holding_registers(address, 1, **self.gui.modbus_thread._unit_kw(1))
    ...
    def write_and_read(self):
        ...
        try:
            ...
            read_result = self.gui.modbus_thread.modbus_client.read_holding_registers(address, 1, **self.gui.modbus_thread._unit_kw(1))
